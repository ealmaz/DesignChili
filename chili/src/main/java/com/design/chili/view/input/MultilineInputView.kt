...
import com.design.chili.view.input.text_watchers.MaxLinesTextWatcher
...
class MultilineInputView : BaseInputView {
    ...
    private fun setMaxLines(charCount: Int) {
        view.inputField.addTextChangedListener(MaxLinesTextWatcher(view.inputField, charCount))
    }

    private fun setMinLines(charCount: Int) {
        view.inputField.minLines = charCount
    }
}